export default function RoleCard({ title, Icon, onClick }) {
  return (
    <div
      onClick={onClick}
      className={`
        btn-active group w-full bg-[#161616] border border-white/[0.04] rounded-[10px] p-10
        cursor-pointer transition-all duration-300 relative flex flex-col items-center justify-center text-center shadow-lg
      `}
    >
      <div className="w-20 h-20 bg-zinc-900 rounded-[10px] flex items-center justify-center mb-8 
