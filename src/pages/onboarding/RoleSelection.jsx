  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] flex flex-col items-center justify-center p-6 bg-[radial-gradient(circle_at_center,_#121212_0%,_#0a0a0a_100%)]">
      <div className="text-center mb-16 fade-up">
        <h1 className="text-5xl font-black text-[#d4a017] tracking-[0.4em] uppercase mb-3 drop-shadow-2xl">
          BusFlow
        </h1>
      ...
      <div className="mt-20 fade-up" style={{ animationDelay: '0.2s' }}>
        <p className="text-[10px] font-black uppercase tracking-[0.3em] text-[#d4a017] drop-shadow-md">
           Secure Fleet Portal
        </p>
      </div>
    </div>
